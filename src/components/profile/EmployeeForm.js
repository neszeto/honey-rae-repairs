...
export const EmployeeForm = () => {
    ...
    const handleSaveButtonClick = (event) => {
        ...
        */
            ...
            fetch(`http://localhost:8088/employees/${profile.id}`, { //this is the unique identifier for the employee object you want to update
                method: "PUT",
                headers: {
                ...
                <div className="form-group">
                    ...
                    <input type="number"
                        ...
                        onChange={
                            (evt) => {
                                const copy = structuredClone(profile)
                                copy.rate = parseFloat(evt.target.value, 2) //this changes it to float (not a string) with 2 decimal points
                                updateProfile(copy)
                            }
                        } />
                </div>
